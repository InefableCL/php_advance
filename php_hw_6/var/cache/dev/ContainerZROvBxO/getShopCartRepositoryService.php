 ...
 */
class getShopCartRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ShopCartRepository' shared autowired service.
     *
     * @return \App\Repository\ShopCartRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ShopCartRepository.php';

        return $container->privates['App\\Repository\\ShopCartRepository'] = new \App\Repository\ShopCartRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
