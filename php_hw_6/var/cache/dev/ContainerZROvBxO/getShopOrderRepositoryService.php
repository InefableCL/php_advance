 ...
 */
class getShopOrderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ShopOrderRepository' shared autowired service.
     *
     * @return \App\Repository\ShopOrderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ShopOrderRepository.php';

        return $container->privates['App\\Repository\\ShopOrderRepository'] = new \App\Repository\ShopOrderRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
