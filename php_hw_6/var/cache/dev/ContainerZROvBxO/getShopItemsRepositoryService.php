 ...
 */
class getShopItemsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ShopItemsRepository' shared autowired service.
     *
     * @return \App\Repository\ShopItemsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ShopItemsRepository.php';

        return $container->privates['App\\Repository\\ShopItemsRepository'] = new \App\Repository\ShopItemsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
